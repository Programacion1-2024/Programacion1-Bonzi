namespace La_deliciosa_lasagna_de_Luciano
{
    ...
    public class Lasagna
    {
        ...
        public int PreparationTimeInMinutes(int numeroCapas)
        {
            int minutosCapas = 2;
            return numeroCapas * minutosCapas;
        }

        public int ElapsedTimeInMinutes(int numeroCapas, int minutesInOven)
        {
            int tiempoPreparacion = PreparationTimeInMinutes(numeroCapas);
            return tiempoPreparacion + minutesInOven;
        }
    }
}
